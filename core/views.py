...
# HttpRequest attributes in action
...
'''
    We can use message package to alert the user..
    There are 5 levels of message:
        1.DEBUG
        2.INFO
        3.SUCCESS
        4.WARNING
    ...
    messages.add_message() takes three parameters:
        1.HttpRequest object
        2.Message level
        3.Message
        
    we can get this message on code using get_message() method or directly within template.
